...
export declare class SpecController {
    static createSpec(req: AuthRequest, res: Response): Promise<Response<any, Record<string, any>> | undefined>;
    static getSpecs(req: AuthRequest, res: Response): Promise<void>;
    static getSpec(req: AuthRequest, res: Response): Promise<Response<any, Record<string, any>> | undefined>;
    ...
    static deleteSpecAndAllVersions(req: AuthRequest, res: Response): Promise<Response<any, Record<string, any>> | undefined>;
    static getSpecVersions(req: Request, res: Response): Promise<Response<any, Record<string, any>> | undefined>;
